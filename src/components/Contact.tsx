    ...
    <section id="contact" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Get in <span className="gradient-heading">Touch</span></h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Interested in collaborating on a data science project or have questions about my work?
            Feel free to reach out and I'll get back to you as soon as possible.
          </p>
        </div>
        
        <div className="flex flex-col lg:flex-row gap-12">
          <Card className="lg:w-2/3 p-6 data-card">
          ...
          <div className="lg:w-1/3">
            <Card className="p-6 data-card mb-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-medium">deepakg@iastate.edu</p>
                </div>
                
                <div>
                  <p className="text-gray-500 text-sm">Location</p>
                  <p className="font-medium">Ames, IA</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 data-card">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/deepak-gadde/" className="bg-blue-800 text-white p-2 rounded-full hover:bg-blue-900 transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
